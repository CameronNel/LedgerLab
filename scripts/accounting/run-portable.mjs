...
const modes = { clarity: 'clarity-check.ts', workspace: 'workspace-check.ts', workday: 'workday-check.ts', review: 'month-review-check.ts', check: 'check.ts', workflows: 'workflow-check.ts', persistence: 'persistence-check.ts', career: 'career-check.ts', desktop: 'desktop-check.ts', workbook: 'workbook-check.ts' };
